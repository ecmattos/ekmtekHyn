            ...
            <div class="card-body">
                <form class="form-horizontal form-material" method="POST" action="{{ route('register') }}">
                    ...
                    <a href="javascript:void(0)" class="text-center db">
                        <img src="/vendor/wrappixel/material-pro/4.2.1/assets/images/logo-icon.png" alt="Home" />
                        <br/>
                        <img src="/vendor/wrappixel/material-pro/4.2.1/assets/images/logo-text.png" alt="Home" />
                    </a>
                    <h3 class="box-title m-t-40 m-b-0">{{ __('Register') }}</h3><small>Create your account and enjoy</small>
                    
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input id="fqdn" placeholder="FQDN" type="fqdn" class="form-control{{ $errors->has('fqdn') ? ' is-invalid' : '' }}" name="fqdn" value="{{ old('fqdn') }}" required>
                        </div>
                    </div>
